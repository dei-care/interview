...
**Sibling:** [`behavioral`](../behavioral/) · **Hub:** [`coding/`](https://github.com/<OWNER>/problem-solving/tree/main/src/coding).
...
| `meta-coding-puzzles` | `cafeteria` | [`solved/meta-coding-puzzles/cafeteria.cpp`](solved/meta-coding-puzzles/cafeteria.cpp) |
| `meta-coding-puzzles` | `director-of-photography-ch1` | [`solved/meta-coding-puzzles/director-of-photography-ch1.cpp`](solved/meta-coding-puzzles/director-of-photography-ch1.cpp) |
| `meta-coding-puzzles` | `director-of-photography-ch2` | [`solved/meta-coding-puzzles/director-of-photography-ch2.cpp`](solved/meta-coding-puzzles/director-of-photography-ch2.cpp) |
| `meta-coding-puzzles` | `kaitenzushi` | [`solved/meta-coding-puzzles/kaitenzushi.cpp`](solved/meta-coding-puzzles/kaitenzushi.cpp) |
| `meta-coding-puzzles` | `portals` | [`solved/meta-coding-puzzles/portals.cpp`](solved/meta-coding-puzzles/portals.cpp) |
| `meta-coding-puzzles` | `rotary-lock-ch1` | [`solved/meta-coding-puzzles/rotary-lock-ch1.cpp`](solved/meta-coding-puzzles/rotary-lock-ch1.cpp) |
| `meta-coding-puzzles` | `rotary-lock-ch2` | [`solved/meta-coding-puzzles/rotary-lock-ch2.cpp`](solved/meta-coding-puzzles/rotary-lock-ch2.cpp) |
| `meta-coding-puzzles` | `scoreboard-inference-ch1` | [`solved/meta-coding-puzzles/scoreboard-inference-ch1.cpp`](solved/meta-coding-puzzles/scoreboard-inference-ch1.cpp) |
| `meta-coding-puzzles` | `scoreboard-inference-ch2` | [`solved/meta-coding-puzzles/scoreboard-inference-ch2.cpp`](solved/meta-coding-puzzles/scoreboard-inference-ch2.cpp) |
| `meta-coding-puzzles` | `stack-stabilization-ch1` | [`solved/meta-coding-puzzles/stack-stabilization-ch1.cpp`](solved/meta-coding-puzzles/stack-stabilization-ch1.cpp) |
| `meta-coding-puzzles` | `uniform-integers` | [`solved/meta-coding-puzzles/uniform-integers.cpp`](solved/meta-coding-puzzles/uniform-integers.cpp) |
