...
One file per family (plus sensitive prompts):

- [Adaptability / change](domains/adaptability-change.md)
- [Ambiguity / scoping](domains/ambiguity-scoping.md)
- [Collaboration / influence](domains/collaboration-influence.md)
- [Communication / alignment](domains/communication-alignment.md)
- [Conflict / disagreement](domains/conflict-disagreement.md)
- [Customer / user trust](domains/customer-user-trust.md)
- [Failure / mistakes / learning](domains/failure-mistakes-learning.md)
- [Mentoring / enabling others](domains/mentoring-enabling-others.md)
- [Ownership / delivery](domains/ownership-delivery.md)
- [Prioritization / tradeoffs](domains/prioritization-tradeoffs.md)
- [Quality / standards / risk](domains/quality-standards-risk.md)
- [Reliability / scale / incidents](domains/reliability-scale-incidents.md)
- [Sensitive prompts](domains/sensitive-prompts.md)
...
- **Closest story + boundary** beats a polished fake for prompts you never lived.

## Related

- [System design hub](../system-design/README.md)
- [Interview monorepo](../../README.md)
